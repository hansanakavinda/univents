    ...
    return (
        <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                <div>
                    <CardTitle>All Hustle Categories</CardTitle>
                    <CardDescription>Manage gig/job hustle categories</CardDescription>
                </div>
                            ...
                            >
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <Button
                                        ...
                                        disabled={isLoading}
                                        className={category._count.hustles > 0 ? "opacity-30 cursor-not-allowed" : ""}
                                        title={category._count.hustles > 0 ? "Cannot delete category containing active hustles" : "Delete category"}
                                    >
                                        🗑️ Delete
                                    </Button>
                                </div>
