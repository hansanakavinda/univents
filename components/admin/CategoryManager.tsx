        ...
        <Card>
            <CardHeader className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4">
                <div>
                    ...
                    <CardDescription className="text-xs">Manage gig categories</CardDescription>
                </div>
                            ...
                            >
                                ...
                                <div className="flex items-center space-x-1 sm:space-x-2 shrink-0">
                                    ...
                                    <Button
                                        ...
                                        size="sm"
                                        className={`text-xs py-1 px-1.5 sm:px-2.5 ${category._count.gigs > 0 ? "opacity-30 cursor-not-allowed" : ""}`}
