    ...
    return (
        <div className="w-full">
            <label className="block text-sm font-medium text-[#4B3621] mb-1.5">
                {label} <span className="text-gray-400 font-normal">(optional, max {MAX_SIZE_MB}MB)</span>
            </label>

            {preview ? (
                <div className="relative rounded-xl overflow-hidden border border-[#E5E5E4]">
                    <Image
                        src={preview}
                        alt="Preview"
                        width={500}
                ...
                <button
                    ...
                    className="
                        w-full py-8 rounded-xl border-2 border-dashed border-[#E5E5E4]
                        hover:border-[#CC5500] hover:bg-[#FFF8F4]
                ...
                >
                    ...
                    <span className="text-xs text-gray-400">PNG, JPG, WebP up to {MAX_SIZE_MB}MB</span>
                </button>
            )}
