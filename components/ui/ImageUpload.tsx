    ...
    return (
        <div className="w-full">
            <label className="block text-sm font-medium text-text-primary mb-1.5">
                {label} <span className="text-text-dim font-normal">(optional, max {MAX_SIZE_MB}MB)</span>
            </label>
            ...
            {preview ? (
                ...
                >
                    ...
                    <span className="text-xs text-text-dim">PNG, JPG, WebP up to {MAX_SIZE_MB}MB</span>
                </button>
            )}
